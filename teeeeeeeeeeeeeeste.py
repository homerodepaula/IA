...
###############################################
entradas_treinamento = pd.read_csv("WINJ20H11.csv", encoding="utf-16", header=None, names=headers, date_parser=pd.to_datetime)
entradas_teste = pd.read_csv("WINJ20H1.csv", encoding="utf-16", header=None, names=headers, date_parser=pd.to_datetime)
###############################################
...
previsores = []
preco_real = []
for i in range(30, 405):
    previsores.append(entradas_treinamento_normalizada[i-30:i, 0:7])
